...
public final class RequestTracker {
    ...
    private static final Logs mLog_f = new Logs("RequestTracker");
    private long mTimeout_b;
    private long mCurrentRequestId_c;
    private long mInitTime_d;
    private IStatusRequest mRequestResult_e;
    ...
    public final void start_a(long requestId, IStatusRequest avy1)
    {
        synchronized (mLock_a)
        {
