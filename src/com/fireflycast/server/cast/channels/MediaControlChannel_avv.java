...
import com.fireflycast.server.cast.MediaInfo_atz;
import com.fireflycast.server.cast.MediaStatus_aud;
import com.fireflycast.server.utils.IStatusRequest_avy;
import com.fireflycast.server.utils.Logs_avu;
import com.fireflycast.server.utils.RequestTracker_avz;
...
public class MediaControlChannel_avv extends CastChannel_avn {
    private static final long a;
    private static final long b;
    private static final long c;
    private static final long d;
    private long mElapsedTime_e;
    private MediaStatus_aud mMediaStatus_f;
    private final Handler mHandler_g = new Handler(Looper.getMainLooper());
    private final RequestTracker_avz mRequestTracker_h;
    private final RequestTracker_avz mRequestTracker_i;
    private final RequestTracker_avz mRequestTracker_l;
    private final RequestTracker_avz mRequestTracker_m;
    private final RequestTracker_avz mRequestTracker_n;
    ...
    private final Runnable mRequestTrackerRunnable_o = new Runnable() {
        ...
        public void run() {
            ...
            synchronized (RequestTracker_avz.mLock_a) {
    ...
    public MediaControlChannel_avv()
    {
        super("urn:x-cast:com.google.cast.media", "MediaControlChannel");
        mRequestTracker_h = new RequestTracker_avz(b);
        mRequestTracker_i = new RequestTracker_avz(c);
        mRequestTracker_l = new RequestTracker_avz(a);
        mRequestTracker_m = new RequestTracker_avz(a);
        mRequestTracker_n = new RequestTracker_avz(a);
        j();
    }

    static void a(MediaControlChannel_avv avv1, boolean flag)
    {
        avv1.a(flag);
    }
    ...
    static boolean a(MediaControlChannel_avv avv1)
    {
        avv1.p = false;
        return false;
    }

    static RequestTracker_avz b(MediaControlChannel_avv avv1)
    {
        return avv1.mRequestTracker_h;
    }

    static RequestTracker_avz c(MediaControlChannel_avv avv1)
    {
        return avv1.mRequestTracker_i;
    }

    static RequestTracker_avz d(MediaControlChannel_avv avv1)
    {
        return avv1.mRequestTracker_l;
    }

    static RequestTracker_avz e(MediaControlChannel_avv avv1)
    {
        return avv1.mRequestTracker_m;
    }

    static RequestTracker_avz f(MediaControlChannel_avv avv1)
    {
    ...
    public final long a()
    {
        MediaInfo_atz atz1 = getMediaInfo_f();
    ...
    public final long getStatus_a(IStatusRequest_avy avy)
    {
    ...
    public final long seekTime_a(IStatusRequest_avy avy, long currentTime, JSONObject customData)
    {
    ...
    public final long load_a(IStatusRequest_avy avy, MediaInfo_atz atz1, long currentTime, JSONObject customData)
    {
        JSONObject jsonobject1;
        long requestId;
        jsonobject1 = new JSONObject();
    ...
    public final void checkReceivedMessage_a_(String message)
    {
        ...
        try {
            ...
            if (type.equals("MEDIA_STATUS")) {
                ...
                if (flag) {
                    mMediaStatus_f = new MediaStatus_aud(jsonobject5);
    ...
    {
        MediaInfo_atz info = getMediaInfo_f();
        if (info != null)
    ...
    public final MediaStatus_aud getMediaStatus_e()
    {
        return mMediaStatus_f;
    }

    public final MediaInfo_atz getMediaInfo_f()
    {
        if (mMediaStatus_f == null)
            return null;
        else
