...
public abstract class ReceiverControlChannel_aun extends CastChannel_avn {
    public String mTransportId_a;
    public final RequestTracker_avz mLaunchRequestTracker_b;
    public final RequestTracker_avz mStopSessionRequestTracker_c;
    public final RequestTracker_avz mGetStatusRequestTracker_d;
    public final RequestTracker_avz mSetVolumeRequestTracker_e;
    public final RequestTracker_avz mSetMuteRequestTracker_f;
    public double mLevel_g;
    public boolean mMuted_h;
    public boolean mFirst_i;
    private final String mReceiverDestinationId_l;
    private final IStatusRequest_avy mLaunchAppResult_m;
    private final IStatusRequest_avy mStopSessionResult_n;
    private final IStatusRequest_avy mGetStatusResult_o;

    public ReceiverControlChannel_aun(String receiverDestinationId)
    {
        ...
        } else
        {
            ...
            mLaunchRequestTracker_b = new RequestTracker_avz(30000L); //10000L
            // m = new C_auo(this, (byte) 0);
            mLaunchAppResult_m = new IStatusRequest_avy() {
            ...
            mStopSessionRequestTracker_c = new RequestTracker_avz(3000L);

            // n = new C_auq(this, (byte) 0);
            mStopSessionResult_n = new IStatusRequest_avy() {
            ...
            mGetStatusRequestTracker_d = new RequestTracker_avz(3000L);

            // o = new C_aup(this, (byte) 0);
            mGetStatusResult_o = new IStatusRequest_avy() {
            ...
            mSetVolumeRequestTracker_e = new RequestTracker_avz(3000L);
            mSetMuteRequestTracker_f = new RequestTracker_avz(3000L);
            return;
        }
    }
    ...
    protected abstract void onConnectToApplicationAndNotify_a(ApplicationInfo_atn appInfo);

    protected abstract void onStatusReceived_a(ApplicationInfo_atn atn1, double level, boolean muted);
    ...
    public final void checkReceivedMessage_a_(String message)
    {
        ...
        try {
            ...
            if ("RECEIVER_STATUS".equals(type)) {
                ...
                ApplicationInfo_atn appInfo;
                appInfo = null;
                if (hasApplications) {
                    JSONArray applications;
                    int len;
                    JSONObject firstApplication;
                    ApplicationInfo_atn atn2;
                    try
                    {
                    ...
                    if (len > 0) {
                        ...
                        atn2 = new ApplicationInfo_atn(firstApplication);
                        appInfo = atn2;
                    }
                }
