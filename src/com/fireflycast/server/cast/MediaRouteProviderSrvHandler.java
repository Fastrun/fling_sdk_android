...
public class MediaRouteProviderSrvHandler extends Handler {
    ...
    public final void handleMessage(Message message)
    {
        ...
        if (!ReplyMessengerHelper.isValid_a(messenger)) {
            if (MediaRouteProviderSrv.isDebugable_b()) {
        ...
        MediaRouteProviderSrv routeProvider = (MediaRouteProviderSrv) mRouteProviderRef_a
                .get();

        if (routeProvider != null) {
            switch (message.what) {
                case 1: // CLIENT_MSG_REGISTER
                    flag = MediaRouteProviderSrv.register_a(routeProvider, messenger, requestId,
                            arg);
                    break;
                case 2: // CLIENT_MSG_UNREGISTER
                    flag = MediaRouteProviderSrv.unRegister_a(routeProvider, messenger,
                            requestId);
                    break;
                case 3: // CLIENT_MSG_CREATE_ROUTE_CONTROLLER
                    ...
                    if (routeId == null) {
                        ...
                        flag = MediaRouteProviderSrv.createRouteController_a(routeProvider,
                                messenger, requestId, arg, routeId);
                    }
                    break;
                case 4: // CLIENT_MSG_RELEASE_ROUTE_CONTROLLER
                    flag = MediaRouteProviderSrv.releaseRouteController_b(routeProvider,
                            messenger,
                            requestId, arg);
                    break;
                case 5: // CLIENT_MSG_SELECT_ROUTE
                    flag = MediaRouteProviderSrv.selectRoute_c(routeProvider, messenger,
                            requestId,
                            arg);
                    break;
                case 6: // CLIENT_MSG_UNSELECT_ROUTE
                    flag = MediaRouteProviderSrv.unselectRoute_d(routeProvider, messenger,
                            requestId,
                            arg);
                    break;
                case 7: // CLIENT_MSG_SET_ROUTE_VOLUME
                    ...
                    if (volume < 0) {
                        ...
                        flag = MediaRouteProviderSrv.setRouteVolume_a(routeProvider, messenger,
                ...
                case 8: // CLIENT_MSG_UPDATE_ROUTE_VOLUME
                    ...
                    if (volume == 0) {
                        ...
                        flag = MediaRouteProviderSrv.updateRouteVolume_b(routeProvider,
                                messenger,
                                requestId, arg, volume);
                    }
                    break;
                case 9: // CLIENT_MSG_ROUTE_CONTROL_REQUEST
                    if (!(obj instanceof Intent)) {
                        ...
                        flag = MediaRouteProviderSrv.routeControlRequest_a(routeProvider,
                                messenger,
                                requestId, arg,
                                (Intent) obj);
                    }
                ...
                case 10: // CLIENT_MSG_SET_DISCOVERY_REQUEST
                    if (obj != null && !(obj instanceof Bundle)) {
                        ...
                        if (request == null || !request.isValid_c())
                            request = null;
                        flag = MediaRouteProviderSrv.setDiscoveryRequest_a(routeProvider,
                                messenger,
                                requestId, request);
                    }
                    break;
        ...
        if (!flag)
        {
            ...
            MediaRouteProviderSrv.sendFailureReplyMsg_a(messenger, requestId);
        }
        return;
    }
}
