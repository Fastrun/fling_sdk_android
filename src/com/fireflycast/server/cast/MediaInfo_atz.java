...
public final class MediaInfo_atz {
    ...
    MediaInfo_atz(String contentId_s) {
    ...
    MediaInfo_atz(JSONObject jsonobject) throws JSONException {
        ...
        if (jsonobject.has("metadata")) {
            ...
            mMediaMetadata_d = new MediaMetadata_aub(
    ...
    void setMetadata_a(MediaMetadata_aub mediametadata) {
        mMediaMetadata_d = mediametadata;
    }

    public MediaMetadata_aub getMetadata() {
    ...
    public final boolean equals(Object other) {
        ...
        if (!(other instanceof MediaInfo_atz))
            return false;

        MediaInfo_atz mediainfo = (MediaInfo_atz) other;
        ...
        return ObjEqualChecker_avo.isEquals_a(mContentId_a, mediainfo.mContentId_a)
                && mStreamType_b == mediainfo.mStreamType_b
                && ObjEqualChecker_avo.isEquals_a(mContentType_c, mediainfo.mContentType_c)
                && ObjEqualChecker_avo.isEquals_a(mMediaMetadata_d, mediainfo.mMediaMetadata_d)
    ...
    public static class Builder {
        ...
        private final MediaInfo_atz mMediaInfo;
        ...
        public Builder setMetadata(MediaMetadata_aub metadata) {
        ...
        public MediaInfo_atz build() throws IllegalArgumentException {
        ...
        public Builder(String contentId) throws IllegalArgumentException {
            if (TextUtils.isEmpty(contentId)) {
                ...
                mMediaInfo = new MediaInfo_atz(contentId);
                return;
            }
        }
    }
