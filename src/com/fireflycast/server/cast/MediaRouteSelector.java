...
public final class MediaRouteSelector {
    ...
    public static MediaRouteSelector fromBundle_a(Bundle bundle)
    {
        if (bundle != null)
    ...
    static void ensureControlCategories_a(MediaRouteSelector selector)
    {
        selector.ensureControlCategories_e();
    }

    static List getControlCategories_b(MediaRouteSelector selector)
    {
