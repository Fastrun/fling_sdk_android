...
public final class MediaRouteSession {
    private static final Logs mLogs_a = new Logs("MediaRouteSession");
    private final CastDeviceController mCastDeviceController_b;
    private final IMediaChannelHelper mMediaChannelHelper_c;
    ...
    private SessionPrivateData mSessionPrivateData_i;
    private boolean j;

    public MediaRouteSession(CastDeviceController axs1, IMediaChannelHelper helper,
            Handler handler)
    {
    ...
    public final synchronized void startSession_a(String applicationId, String sessionId, boolean relaunchIfRunning)
    {
        ...
        switch (k) {
            case 1:
                mPendingState_f = 2;
                mSessionPrivateData_i = new SessionPrivateData(this, applicationId, sessionId, relaunchIfRunning);
                break;
            case 2:
                mPendingState_f = 2;
                mSessionPrivateData_i = new SessionPrivateData(this, applicationId, sessionId, relaunchIfRunning);
