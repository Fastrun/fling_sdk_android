...
import com.fireflycast.server.cast.auth.CastX509TrustManager_atm;
...
final class SSLSocketEngine_aug {
    private static final Logs_avu mLogs_a = new Logs_avu("SSLSocketEngine");
    ...
    public SSLSocketEngine_aug(SocketChannel socketchannel, SocketBuf_atx atx1, SocketBuf_atx atx2)
    {
    ...
    private void checkHandshakeStatus_a(SSLEngineResult sslengineresult)
    {
        ...
        switch (CastSSLEngineResult_auh.mHandshakeStatus_b[mHandshakeStatus_i.ordinal()])
        {
            default:
                return;
    ...
    public final void readFromChannel_e() throws IOException
    {
        ...
        while (true) {
            ...
            if (l > 0)
                mReadAtx_d.b(l);
            switch (CastSSLEngineResult_auh.mStatus_a[sslengineresult.getStatus().ordinal()]) {
    ...
    static
    {
        ...
        try
        {
            mSSLContext_b.init(null, CastX509TrustManager_atm.a, new SecureRandom());
