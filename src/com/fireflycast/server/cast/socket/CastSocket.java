...
public final class CastSocket {
    private static final Logs mLogs_a = new Logs("CastSocket");
    private static final boolean DEBUG = false;
    private final CastSocketListener mSocketListener_b;
    private SocketChannel mSocketChannel_c;
    private SocketBuf mReadAtx_d;
    private SocketBuf mWriteAtx_e;
    private final CastSocketMultiplexer mCastSocketMultiplexer_f;
    private final int g;
    ...
    private long m;
    private boolean n;
    private SSLSocketEngine mSSLSocketEngine_o;

    public CastSocket(Context context, CastSocketListener listener_atu1)
    {
        if (listener_atu1 == null)
        {
            ...
            mSocketStatus_h = 0;
            g = 0x1fffc;
            mCastSocketMultiplexer_f = CastSocketMultiplexer.getInstance_a(context);
    ...
    final synchronized SocketChannel startConnect_a() throws IOException
    {
        ...
        mReadAtx_d = new SocketBuf();
        mWriteAtx_e = new SocketBuf();
        mSSLSocketEngine_o = new SSLSocketEngine(mSocketChannel_c,
