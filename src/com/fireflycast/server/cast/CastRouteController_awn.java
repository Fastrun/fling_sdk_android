...
import com.fireflycast.server.cast.channels.MediaControlChannel_avv;
import com.fireflycast.server.cast.channels.MirroringControlChannel_aum;
import com.fireflycast.server.cast.media.MediaItemStatusHelper_nr;
...
import com.fireflycast.server.utils.IStatusRequest_avy;
...
public final class CastRouteController_awn extends RouteController_nz implements
        IStatusRequest_avy,
        IMediaChannelHelper_axf {
    public final CastDevice mCastDevice_a;
    public CastDeviceController_axs mCastDeviceController_b;
    double c;
    String d;
    public MediaRouteSession_axe mMediaRouteSession_e;
    public int f;
    public String mSessionId_g;
    boolean h;
    public boolean i;
    JGCastService mJGCastService_j;
    public final CastMediaRouteProvider_awb mCastMediaRouteProvider_k;
    private String mApplicationId_l;
    private boolean isRelaunchApp_m;
    private boolean n;
    private RemotePlaybackRequest_awt o;
    private RemotePlaybackRequest_awt p;
    private RemotePlaybackRequest_awt mSyncStatusRequest_q;
    private PendingIntent mPendingIntent_r;
    private MediaControlChannel_avv mMediaControlChannel_s;
    private long mLoadRequestId_t;
    private boolean u;
    private MirroringControlChannel_aum mMirroringControlChannel_v;
    private final List w = new LinkedList();
    private TrackedItem_aws mTrackedItem_x;

    public CastRouteController_awn(CastMediaRouteProvider_awb awb1, CastDevice castdevice) {
        super();
        mCastMediaRouteProvider_k = awb1;
        mApplicationId_l = (String) CastMediaRouteProvider_awb.i.b();
    ...
    private static Bundle a(JSONObject jsonobject) {
        ...
        if (jsonobject.has("httpHeaders")) {
            try {
                Bundle httpHeaders = CastMediaManagerHelper_axk.getBundle_a(jsonobject
    ...
    private void a(Intent intent) {
        ...
        if (bundle.containsKey("com.fireflycast.cast.EXTRA_DEBUG_LOGGING_ENABLED")) {
            ...
            if (flag)
                ...
                l1 &= -2L;
            CastMediaRouteProvider_awb.getLogs_a().setDebugEnabled_a(flag);
        }
        mCastDeviceController_b.setDebugLevel_a(l1);
    }

    private void a(TrackedItem_aws aws1) {
        if (mTrackedItem_x == aws1)
            mTrackedItem_x = null;
        w.remove(aws1);
    }

    private void sendPlaybackStateForItem_a(TrackedItem_aws item, int playbackState, Bundle bundle) {
        ...
        MediaItemStatusHelper_nr nr1 = (new MediaItemStatusHelper_nr(playbackState)).a(SystemClock
                .uptimeMillis());
        if (bundle != null)
            nr1.a(bundle);
        ...
        try {
            item.mPendingIntent_d.send(
                    ((MediaRouteProvider_nv) (mCastMediaRouteProvider_k)).mContext_a, 0, intent);
            return;
        } catch (android.app.PendingIntent.CanceledException canceledexception) {
            CastMediaRouteProvider_awb.getLogs_a().d(canceledexception,
                    "exception while sending PendingIntent", new Object[0]);
        }
    }

    private boolean processRemotePlaybackRequest_a(RemotePlaybackRequest_awt awt1) {
        String albumTitle;
        Integer discNumber;
        Integer trackNumber;
        CastMediaRouteProvider_awb.getLogs_a().d("processRemotePlaybackRequest()", new Object[0]);
        ...
        Uri uri;
        Bundle bundle4;
        MediaMetadata_aub aub1;
        String albumArtist;
        String composer;
        String title;
        String artist;
        String artworkUri;
        MediaInfoContainer_aua aua1;
        String contentType;
        MediaInfo_atz atz1;
        MediaInfo_atz atz2;
        MediaInfo_atz atz3;
        ...
        String s11;
        if (bundle != null)
            jsonobject = CastMediaManagerHelper_axk.getJsonObject_a(bundle, null);
        else
            jsonobject = null;
        CastMediaRouteProvider_awb.getLogs_a().d("got remote playback request; action=%s",
                new Object[] {
                    action
                });
        try {
            if (!action.equals("android.media.intent.action.PLAY") || intent.getData() == null) {
                if (action.equals("android.media.intent.action.PAUSE")) {
                    ...
                    try {
                        ...
                        CastMediaRouteProvider_awb.getLogs_a().w(ioexception4,
                ...
                if (action.equals("android.media.intent.action.RESUME")) {
                    ...
                    try {
                        ...
                        CastMediaRouteProvider_awb.getLogs_a().w(ioexception3,
                                "exception while processing %s", new Object[] {
                                    action
                                });
                        awt1.onRouteCtrlRequestFailed_a(1);
                ...
                if (action.equals("android.media.intent.action.STOP")) {
                    ...
                    try {
                        ...
                        CastMediaRouteProvider_awb.getLogs_a().w(ioexception2,
                                "exception while processing %s", new Object[] {
                                    action
                                });
                        awt1.onRouteCtrlRequestFailed_a(1);
                ...
                if (action.equals("android.media.intent.action.SEEK")) {
                    ...
                    itemPosition = intent.getLongExtra("android.media.intent.extra.ITEM_POSITION",
                            0L);
                    try {
                        avu2 = CastMediaRouteProvider_awb.getLogs_a();
                        aobj1 = new Object[1];
                        ...
                        CastMediaRouteProvider_awb.getLogs_a().w(ioexception1,
                                "exception while processing %s", new Object[] {
                                    action
                                });
                        awt1.onRouteCtrlRequestFailed_a(1);
                ...
                if (action.equals("com.fireflycast.cast.ACTION_SYNC_STATUS")) {
                    ...
                    try {
                        ...
                        CastMediaRouteProvider_awb.getLogs_a().w(ioexception,
                                "exception while processing %s", new Object[] {
                                    action
                                });
                        awt1.onRouteCtrlRequestFailed_a(1);
                ...
                if (!TextUtils.isEmpty(appId)) {
                    ...
                    s3 = (String) CastMediaRouteProvider_awb.i.b();
                }
            ...
            if (intent.getStringExtra("android.media.intent.extra.SESSION_ID") == null) {
                ...
                if (TextUtils.isEmpty(s11))
                    s11 = (String) CastMediaRouteProvider_awb.i.b();
            ...
            if (uri == null)
                return false;
            CastMediaRouteProvider_awb.getLogs_a().d("Device received play request, uri %s",
                    new Object[] {
                        uri
                    });
            a(intent);
            ...
            if (bundle4 != null) {
                ...
                if (albumTitle == null && discNumber == null && trackNumber == null) {
                    aub1 = new MediaMetadata_aub(0);

                } else {
                    aub1 = new MediaMetadata_aub(3);
                    if (albumTitle != null)
            ...
            aua1 = new MediaInfoContainer_aua(uri.toString());
            ...
            if (!TextUtils.isEmpty(contentType)) {
                ...
                if (bundle5 == null) {
                    ...
                    try {
                        jsonobject2 = CastMediaManagerHelper_axk.getJsonObject_a(bundle5, null);
                        if (jsonobject == null) {
                ...
                try {
                    aws1 = new TrackedItem_aws(this, mMediaControlChannel_s.load_a(this, atz3, pos,
                            jsonobject1));
                    aws1.mPendingIntent_d = pendingintent1;
                    w.add(aws1);
                    avu3 = CastMediaRouteProvider_awb.getLogs_a();
                    aobj2 = new Object[1];
                    ...
                    bundle6.putBundle("android.media.intent.extra.ITEM_STATUS",
                            (new MediaItemStatusHelper_nr(3)).a(SystemClock.uptimeMillis())
                                    .createMediaItemStatus_a().mBundle_a);
                    awt1.onRouteCtrlRequestOk_a(bundle6);
                    // } catch (IOException ioexception5) {
                } catch (Exception ioexception5) {
                    CastMediaRouteProvider_awb.getLogs_a().w(ioexception5,
    ...
    private boolean checkSession_a(RemotePlaybackRequest_awt awt1, int i1) {
    ...
    private void resumeSession_c(String sessionId) {
        CastMediaRouteProvider_awb.getLogs_a().d("resumeSession()", new Object[0]);
    ...
    private void startSession_e(int i1) {
        CastMediaRouteProvider_awb.getLogs_a().d("startSession()", new Object[0]);
        if (i1 == 1) {
            MediaRouteSession_axe axe1 = mMediaRouteSession_e;
            int j1 = ((WifiManager) ((MediaRouteProvider_nv) (mCastMediaRouteProvider_k)).mContext_a
    ...
    private void f(int i1) {
        for (Iterator iterator = w.iterator(); iterator.hasNext(); sendPlaybackStateForItem_a(
                (TrackedItem_aws) iterator.next(), i1, ((Bundle) (null))))
            ;
        w.clear();
        mTrackedItem_x = null;
    }
    ...
    private Bundle getItemStatusBundle_i() {
        ...
        if (aud1 != null) {
            ...
            MediaItemStatusHelper_nr nr1 = new MediaItemStatusHelper_nr(byte0);
            ...
            MediaItemStatusHelper_nr nr2 = nr1.a(SystemClock.uptimeMillis());
            Bundle bundle = a(aud1.mCustomData_g);
            if (bundle != null)
                nr2.a(bundle);
            return nr2.createMediaItemStatus_a().mBundle_a;
        }
        CastMediaRouteProvider_awb.getLogs_a().d("*** media status is null!", new Object[0]);
        return (new MediaItemStatusHelper_nr(byte0)).createMediaItemStatus_a().mBundle_a;
    }

    public final void onRelease_a() {
        CastMediaRouteProvider_awb.getLogs_a().d("Controller released", new Object[0]);
    }
    ...
    public final void onSetVolume_a(int i1) {
        ...
        try {
            ...
            Logs_avu avu2 = CastMediaRouteProvider_awb.getLogs_a();
    ...
    public final void requestStatus_a(long loadRequestId, int status, JSONObject jsonobject) {
        ...
        do {
            ...
            aws1 = (TrackedItem_aws) iterator.next();
        } while (aws1.mLoadRequestId_b != loadRequestId);
        if (aws1 == null) {
            if (loadRequestId != mLoadRequestId_t) {
                return;
            }
            CastMediaRouteProvider_awb.getLogs_a().d("requestStatus has completed", new Object[0]);
            mLoadRequestId_t = -1L;
            long sessionId;
            Iterator iterator1;
            try {
                ...
                TrackedItem_aws aws2;
                do {
                    if (!iterator1.hasNext()) {
                        aws2 = null;
                        break;
                    }
                    aws2 = (TrackedItem_aws) iterator1.next();
                ...
                if (mSyncStatusRequest_q != null) {
                    TrackedItem_aws aws3 = new TrackedItem_aws(this);
                ...
                while (iterator2.hasNext()) {
                    TrackedItem_aws aws4 = (TrackedItem_aws) iterator2.next();
            ...
            if (mSyncStatusRequest_q != null) {
                if (status == 0) {
                    ...
                    if (mTrackedItem_x != null) {
                        MediaStatus_aud aud1 = mMediaControlChannel_s.getMediaStatus_e();
                        ...
                        bundle.putParcelable("android.media.intent.extra.ITEM_STATUS",
                                getItemStatusBundle_i());
                        MediaInfo_atz atz1 = aud1.mMedia_b;
                        if (atz1 != null) {
                            Bundle bundle1 = CastMediaManagerHelper_axk
                                    .createMetadataBundle_a(atz1);
                            CastMediaRouteProvider_awb.getLogs_a().d("adding metadata bundle: %s",
                                    new Object[] {
                                        bundle1
                                    });
        ...
        switch (status) {
            default:
            case 1:
                Logs_avu avu3 = CastMediaRouteProvider_awb.getLogs_a();
            ...
            case 0:
                ...
                break;
            case 2:
                CastMediaRouteProvider_awb.getLogs_a().d("STATUS_CANCELED; sending error state",
                        new Object[0]);
                sendPlaybackStateForItem_a(aws1, 5, ((Bundle) (null)));
                a(aws1);
                break;
            case 3:
                CastMediaRouteProvider_awb.getLogs_a().d("STATUS_TIMED_OUT; sending error state",
                        new Object[0]);
    ...
    public final void attachMediaChannel_a(String sessionId)
    {
        ...
        if (mApplicationId_l.equals(applicationmetadata.getApplicationId_b())) {
            CastMediaRouteProvider_awb.getLogs_a().d("attachMediaChannel", new Object[0]);

            // mMediaControlChannel_s = new C_awo(this);
            mMediaControlChannel_s = new MediaControlChannel_avv() {
                protected final void onStatusUpdated_h() {
                    CastMediaRouteProvider_awb.getLogs_a().d("onStatusUpdated", new Object[0]);
                    sendItemStatusUpdate_h();
                }
            ...
            if ("674A0243".equals(applicationmetadata.getApplicationId_b())) {
                ...
                mMirroringControlChannel_v = new MirroringControlChannel_aum(mCastDevice_a,
                        mCastDeviceController_b.getTransId_o()) {
                    protected final void onAnswer_b(final String s) {
                        CastMediaRouteProvider_awb.getLogs_a().d("onAnswer", new Object[0]);
                        // ((C_nv) (a.mCastMediaRouteProvider_k)).c.post(new
                        // C_awq(this, s));
                        ((MediaRouteProvider_nv) (mCastMediaRouteProvider_k)).mHandler_c
                                .post(new Runnable() {
                ...
                try {
                    ...
                    CastMediaRouteProvider_awb.getLogs_a().d(ioexception, "Failed to send offer",
                            new Object[0]);
                }
            }
        }
    ...
    final void sendPendingIntent_a(String sessionId, int sessionStatus) {
        ...
        try {
            ...
            mPendingIntent_r.send(((MediaRouteProvider_nv) (mCastMediaRouteProvider_k)).mContext_a,
                    0, intent);
            return;
        } catch (android.app.PendingIntent.CanceledException canceledexception) {
            CastMediaRouteProvider_awb.getLogs_a().d(canceledexception,
    ...
    final void a(boolean flag) {
        if (CastMediaRouteProvider_awb.f(mCastMediaRouteProvider_k) != null)
            CastMediaRouteProvider_awb.f(mCastMediaRouteProvider_k).a(mCastDevice_a, flag);
    }

    public final boolean onControlRequest_a(Intent intent, RouteCtrlRequestCallback_om om) {
        boolean flag;
        CastMediaRouteProvider_awb.getLogs_a().d("Received control request %s", new Object[] {
                intent
        });
        RemotePlaybackRequest_awt awt1 = new RemotePlaybackRequest_awt(mCastMediaRouteProvider_k,
                intent, om);
    ...
    public final void onSelect_b() {
        CastMediaRouteProvider_awb.getLogs_a().d("onSelect", new Object[0]);
        mCastDeviceController_b = CastMediaRouteProvider_awb.createDeviceController_a(
                mCastMediaRouteProvider_k, this);
        mMediaRouteSession_e = new MediaRouteSession_axe(mCastDeviceController_b, this,
                ((MediaRouteProvider_nv) (mCastMediaRouteProvider_k)).mHandler_c);
    }
    ...
    public final void disconnectCastMirror_b(boolean flag) {
        if (i) {
            if (mJGCastService_j != null) {
                CastMediaRouteProvider_awb.getLogs_a().d("Destroying mirroring client",
                        new Object[0]);
    ...
    public final void onUnselect_c() {
        CastMediaRouteProvider_awb.getLogs_a().d("onUnselect", new Object[0]);
        endSession_d();
        CastMediaRouteProvider_awb.b(mCastMediaRouteProvider_k, this);
    ...
    public final void detachMediaChannel_d(int i1) {
        ...
        f(byte0);
        if (!i) {
            CastMediaRouteProvider_awb.getLogs_a().d("detachMediaChannel", new Object[0]);
            if (mMediaControlChannel_s != null) {
                if (mCastDeviceController_b != null)
    ...
    public final void startSession_f() {
        switch (f) {
            case 1:
                CastMediaRouteProvider_awb.getLogs_a().d("starting pending session for mirroring",
                        new Object[0]);
                startSession_e(1);
                break;
            case 2:
    ...
    final void sendItemStatusUpdate_h() {
        ...
        if (mTrackedItem_x != null) {
            ...
            if (pendingintent != null) {
                ...
                MediaInfo_atz atz1 = mMediaControlChannel_s.getMediaInfo_f();
                if (atz1 != null) {
                    Bundle bundle = CastMediaManagerHelper_axk.createMetadataBundle_a(atz1);
                    Logs_avu avu4 = CastMediaRouteProvider_awb.getLogs_a();
                ...
                try {
                    ...
                    pendingintent.send(
                            ((MediaRouteProvider_nv) (mCastMediaRouteProvider_k)).mContext_a, 0,
                            intent);
                } catch (android.app.PendingIntent.CanceledException canceledexception) {
                    CastMediaRouteProvider_awb.getLogs_a().d(canceledexception,
                            "exception while sending PendingIntent", new Object[0]);
