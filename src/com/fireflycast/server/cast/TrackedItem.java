...
final class TrackedItem {
    ...
    final CastRouteController mCastRouteController_e;

    public TrackedItem(CastRouteController controller)
    {
        this(controller, -1L);
    }

    public TrackedItem(CastRouteController controller, long requestId)
    {
        super();
