...
public abstract class IFireflyCallbacksStub extends Binder implements IFireflyCallbacks {
    public IFireflyCallbacksStub()
    {
        attachInterface(this, "com.fireflycast.common.internal.IFireflyCallbacks");
    }

    public static IFireflyCallbacks a(IBinder ibinder) // asInterface
    {
        if (ibinder == null)
            return null;
        android.os.IInterface iinterface = ibinder
                .queryLocalInterface("com.fireflycast.common.internal.IFireflyCallbacks");
        if (iinterface != null && (iinterface instanceof IFireflyCallbacks))
            return (IFireflyCallbacks) iinterface;
        else
            return new IFireflyCallbacksProxy(ibinder); // GmsCallbacksProxy?
    }
