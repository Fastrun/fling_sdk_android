...
public final class CastConnectedClient implements ICastSrvController {
    final CastService mCastService_a;
    private CastDeviceControllerStub mCastDevCtrl_b;
    private final ICastDeviceControllerListener mICastDevCtlListener_c;
    ...
    private CastDeviceController mCastDeviceCtrl_i;
    private final IFireflyCallbacks mFireflyCallbacks_j;
    private final String mPackageName_k;
    private final long mFlags_l;

    CastConnectedClient(CastService castservice, IFireflyCallbacks bgj1, CastDevice castdevice,
            String lastApplicationId_s, String lastSessionId_s1,
            ICastDeviceControllerListener avr1, String packageName_s2,
            long flags_l1)
    {
        super();
        ...
        mFireflyCallbacks_j = (IFireflyCallbacks) EmptyChecker.a(bgj1);
        ...
        mFireflyCallbackDeathHandler_d = new DeathRecipient() {
            ...
            public void binderDied() {
                ...
                handleBinderDeath_a(CastConnectedClient.this);
            }
        ...
        mCastDeviceCtrl_i = CastDeviceController.createCastDeviceController_a(mCastService_a,
                CastService.getHandler_b(mCastService_a), mPackageName_k, mCastDevice_f, mFlags_l,
                this);
        mCastDevCtrl_b = new CastDeviceControllerImpl(mCastService_a, mCastDeviceCtrl_i);
        ...
        {
            Logs avu2 = CastService.getLogs_a();
    ...
    static void handleBinderDeath_a(CastConnectedClient connectedClient)
    {
    ...
    {
        Logs avu1 = CastService.getLogs_a();
