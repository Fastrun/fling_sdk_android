...
public final class CastDeviceControllerImpl extends CastDeviceControllerStub {
    final CastService mCastService_a;
    private final CastDeviceController mCastDeviceController_b;

    public CastDeviceControllerImpl(CastService castservice, CastDeviceController axs1)
    {
        super();
