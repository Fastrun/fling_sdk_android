...
abstract class MdnsClient_auz {
    private static final Logs_avu mLogs_a = new Logs_avu("MdnsClient");
    ...
    static void handleReceive_a(MdnsClient_auz mdnsClient) throws IOException {
        ...
        while (!mdnsClient.mStopScan_g) {
            try {
                ...
                localavj = new MdnsClientDpHelper_avj(datagramPacket);
                localavj.b();
                localavj.b();
                int j = localavj.b();
                k = localavj.b();
            ...
            localavj.b();
            localavj.b();
            localavm = new CastDeviceInfoContainer_avm(str1);
            ...
            for (int i1 = 0;; i1++) {
                ...
                if (i1 < n + (k + m)) {
                    ...
                    if ((i1 < k) && (l4 > 0L) && (l4 < 604800L)) {
                        ...
                        MdnsClientPrivData_avc localavc = new MdnsClientPrivData_avc(arrayOfByte7,
                                (int) l4);
                        localSet.add(new SoftReference(localavc));
                    }
                    CastDeviceInfo_avl localavl1 = localavm.mCastDeviceInfo_a;
                    ...
                    switch (i2) {
                        case 1:
                            ...
                            try {
                                ...
                                CastDeviceInfo_avl localavl4 = localavm.mCastDeviceInfo_a;
                        ...
                        case 16:
                            ...
                            while (localavj.a() > 0) {
                                ...
                                CastDeviceInfo_avl localavl2 = localavm.mCastDeviceInfo_a;
                        ...
                        case 28:
                            ...
                            try {
                                ...
                                CastDeviceInfo_avl localavl3 = localavm.mCastDeviceInfo_a;
    ...
    static void handleSend_b(MdnsClient_auz mdnsClient) {
        int j = 1;
        int k = 1000;
        MdnsClientOutputStreamHelper_avk localavk;
        int n;
        int i1;
        int i4;
        ...
        while (!mdnsClient.mStopScan_g) {
            try {
                ...
                localavk = new MdnsClientOutputStreamHelper_avk();
                Iterator localIterator1 = mdnsClient.i.iterator();
                n = 1024;
                while (localIterator1.hasNext()) {
                    if (n <= 1024) {
                        MdnsClientPrivData_avc localavc1 = (MdnsClientPrivData_avc) ((SoftReference) localIterator1
                                .next()).get();
                        if (localavc1 != null) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    byte[] arrayOfByte1 = arrayOfString[i3]
                            .getBytes(CharsetAndInetAddrInfo_avd.mCharset_a);
                ...
                while (localIterator2.hasNext()) {
                    MdnsClientPrivData_avc localavc2 = (MdnsClientPrivData_avc) ((SoftReference) localIterator2
                            .next()).get();
                    if (localavc2 != null)
        ...
        try {
            ...
            this.mReceiveThread_e = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        handleReceive_a(MdnsClient_auz.this);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
            ...
            this.mSendThread_f = new Thread(new Runnable() {
                ...
                public void run() {
                    // TODO Auto-generated method stub
                    handleSend_b(MdnsClient_auz.this);
                }
    ...
    protected abstract void onScanResults_a(CastDeviceInfo_avl paramavl);
