...
public final class MdnsDeviceScanner_ave extends DeviceScanner_aur {
    private static final Logs_avu mLogs_c = new Logs_avu("MdnsDeviceScanner");
    ...
    public MdnsDeviceScanner_ave(Context paramContext) {
        super(paramContext);
        this.mName_f = "Cast Device";
    }

    static void scanLoop_a(final MdnsDeviceScanner_ave paramave) {
        while (!paramave.h) {
            try {
                Thread.sleep(3000L);
            ...
            synchronized (paramave.e) {
                ...
                while (localIterator.hasNext()) {
                    ScannerPrivData_avi localavi = (ScannerPrivData_avi) ((Map.Entry) localIterator
                            .next()).getValue();
                    int i = 0;
    ...
    static void onScanResults_a(MdnsDeviceScanner_ave deviceScanner, CastDeviceInfo_avl info) {
        ...
        if (localList1 != null) {
            ...
            synchronized (deviceScanner.e) {
                ...
                CastDeviceHelper_atr localatr = CastDevice.a((String) deviceId,
                        localInet4Address1);
                String str3 = info.e;
                ...
                localavi = (ScannerPrivData_avi) deviceScanner.e.get(deviceId);
                if (localavi != null) {
                ...
                deviceScanner.e.put(deviceId, new ScannerPrivData_avi(deviceScanner, castDevice,
                        info.mTTL_l));
            }
            ...
            if (castDevice == null)
                return;
            DeviceScanner_aur.mLogs_a.d("notifyDeviceOnline: %s",
                    new Object[] {
                        castDevice
                    });
            ...
            deviceScanner.mHandler_b.post(new Runnable() {
                ...
                public void run() {
                    ...
                    while (localIterator.hasNext())
                        ((IDeviceScanListener_auy) localIterator.next())
    ...
    public final void setDeviceOffline_a(String paramString) {
        ...
        synchronized (this.e) {
            ScannerPrivData_avi localavi = (ScannerPrivData_avi) this.e.get(paramString);
            if (localavi != null) {
                localavi.mElapsedRealtime_b = SystemClock.elapsedRealtime();
                localavi.d = true;
    ...
    protected final void startScanInternal_a(List networkInterfaceList) {
        ...
        while (localIterator.hasNext()) {
            ...
            MdnsClient_auz castMdnsClient = new MdnsClient_auz("_googlecast._tcp.local.",localNetworkInterface) {

                @Override
                protected void onScanResults_a(CastDeviceInfo_avl info) {
                    // TODO Auto-generated method stub
                    MdnsDeviceScanner_ave.onScanResults_a(MdnsDeviceScanner_ave.this, info);
                }
        ...
        this.mScannerLoopThread_g = new Thread(new Runnable() {
            ...
            public void run() {
                // TODO Auto-generated method stub
                scanLoop_a(MdnsDeviceScanner_ave.this);
            }
    ...
    protected final void stopScanInternal_c() {
        if (!this.mCastMdnsClientList_d.isEmpty()) {
            ...
            while (localIterator.hasNext())
                ((MdnsClient_auz) localIterator.next()).stopScan_b();
