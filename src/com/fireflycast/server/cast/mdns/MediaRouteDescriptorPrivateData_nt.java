...
public final class MediaRouteDescriptorPrivateData_nt {
    public final Bundle mBundle_a = new Bundle();
    public ArrayList mControlIntentFilterList_b;

    public MediaRouteDescriptorPrivateData_nt(String id, String name)
    {
        mBundle_a.putString("id", id);
        mBundle_a.putString("name", name);
    }

    public final MediaRouteDescriptorPrivateData_nt addIntentFilterList_a(Collection collection)
    {
        if (collection == null)
