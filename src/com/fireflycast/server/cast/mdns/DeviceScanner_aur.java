...
public abstract class DeviceScanner_aur {
    static final Logs_avu mLogs_a = new Logs_avu("DeviceScanner");
    ...
    protected DeviceScanner_aur(Context context) {
        e = 0;
        mContext_c = context;
    ...
    static ConnectivityManager a(DeviceScanner_aur aur1) {
    ...
    static boolean getErrorState_b(DeviceScanner_aur aur1) {
        return aur1.mErrorState_n;
    }

    static void checkBSSID_c(DeviceScanner_aur aur1) {
        aur1.checkBSSID_l();
    }

    static boolean d(DeviceScanner_aur aur1) {
        return aur1.m;
    }

    static void stopScanInit_e(DeviceScanner_aur aur1) {
        aur1.stopScanInit_k();
    }

    static boolean f(DeviceScanner_aur aur1) {
        aur1.m = false;
        return false;
    }

    static void startScanInit_g(DeviceScanner_aur aur1) {
        aur1.startScanInit_j();
    }

    static Logs_avu getLogs_h() {
        return mLogs_a;
    }
        ...
        if (mConnectChangeReceiver_h == null) {
            ...
            mConnectChangeReceiver_h = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    {
                        connected = true;
                        Logs_avu localavu = DeviceScanner_aur.getLogs_h();
                        ...
                        DeviceScanner_aur.getLogs_h().d("lost connectivity while scanning;", new Object[0]);
                        g();
                    }
                }
    ...
    public final void addListener_a(IDeviceScanListener_auy auy) {
        if (auy == null)
    ...
    protected final void notifyDeviceOffline_a(final CastDevice castdevice) {
        ...
        if (list != null) {
            ...
            mHandler_b.post(new Runnable() {
                ...
                public void run() {
                    // TODO Auto-generated method stub
                    for (Iterator iterator = list.iterator(); iterator.hasNext(); ((IDeviceScanListener_auy) iterator
