...
import com.fireflycast.client.common.api.FireflyApiClientImpl.FireflyApiClientTask;
...
public class FireflyApi {
	public static abstract class FireflyApiImpl_a<R extends Result, A extends Api.ConnectionApi_a>
		...
		private FireflyApiClientImpl.ReleaseCallback_a mReleaseCallback_zm;
		...
		public void setReleaseCallback_a(
				FireflyApiClientImpl.ReleaseCallback_a callback) {
		...
		public final R await() {
			ValueChecker.checkTrueWithErrorMsg(!(this.mIsResultConsumed_zj),
