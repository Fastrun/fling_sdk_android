...
import com.fireflycast.cast.FireflyApi_a.ResultCallback_c;
import com.fireflycast.cast.Status;

public class CastClientImpl_dq extends
		FireflyClient_eh<ICastDeviceController_ds> {
	...
	private final ICastDeviceControllerListener_dt mICastDeviceControllerListener_xH;
	...
	public static LogUtil_du getLogUtil_dc() {
		return CastClientImpl_dq.mLogUtil_xE;
	}

	public CastClientImpl_dq(Context context, Looper looper, CastDevice device,
		 ...
		 */
		this.mICastDeviceControllerListener_xH = new ICastDeviceControllerListener_dt.Stub_a() {
	...
	private void notifyCastListener_a(String applicationStatus, double volume,
		...
		if (!(DoubleAndLongConverter_dr.compare_a(applicationStatus,
	...
	protected ICastDeviceController_ds getService_p(IBinder binder) {
		return ICastDeviceController_ds.Stub_a.asInterface_w(binder);
	}
