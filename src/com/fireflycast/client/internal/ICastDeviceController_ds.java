...
public interface ICastDeviceController_ds extends IInterface {
	...
	public static abstract class Stub_a extends Binder implements
			ICastDeviceController_ds {
		public static ICastDeviceController_ds asInterface_w(IBinder obj) {
			if (obj == null)
				return null;
			IInterface local = obj
					.queryLocalInterface("com.fireflycast.cast.internal.ICastDeviceController");
			if ((local != null) && (local instanceof ICastDeviceController_ds)) {
				return ((ICastDeviceController_ds) local);
			}
		...
		private static class Proxy_a implements ICastDeviceController_ds {
			private IBinder ky;
