...
import com.fireflycast.client.internal.FireflyClient_eh.FireflyClientServiceConnection_f;
...
public class FireflyServiceManager_ej implements Handler.Callback {

	private static final Object mLock_BQ = new Object();
	private static FireflyServiceManager_ej mInstance_BR;
	...
	public static FireflyServiceManager_ej getInstance_y(Context context) {
		synchronized (mLock_BQ) {
			if (mInstance_BR == null)
				mInstance_BR = new FireflyServiceManager_ej(
						context.getApplicationContext());
		}
		return mInstance_BR;
	}

	private FireflyServiceManager_ej(Context context) {
