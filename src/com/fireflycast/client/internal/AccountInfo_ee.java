...
import com.fireflycast.client.internal.AccountInfoCreator_eq;

public class AccountInfo_ee {

	private final AccountInfo_a accountInfo_Bo;
	private final View mView_zp;

	public AccountInfo_ee(String accountName,
	...
	public static final class AccountInfo_a implements SafeParcelable {
		public static final AccountInfoCreator_eq CREATOR = new AccountInfoCreator_eq();
		...
		public void writeToParcel(Parcel out, int flags) {
			AccountInfoCreator_eq.buildParcel_a(this, out, flags);
		}
