 ...
 */
public class FireflyClientEvents_ei {
    ...
    public FireflyClientEvents_ei(Context paramContext, Looper paramLooper, FmsClientEventCallback_b callback) {
    ...
    public void notifyOnConnected_b(Bundle bundle) {
        synchronized (mCallbacks_BK) {
            ValueChecker_er.checkTrue(!mIsNotifingCallbacks_BM);
            mHandler.removeMessages(1);
            mIsNotifingCallbacks_BM = true;
            ValueChecker_er.checkTrue(mCallbacks_BL.size() == 0);
    ...
    public void registerConnectionCallbacks(ConnectionCallbacks listener) {
        ValueChecker_er.checkNullPointer_f(listener);
        synchronized (mCallbacks_BK) {
