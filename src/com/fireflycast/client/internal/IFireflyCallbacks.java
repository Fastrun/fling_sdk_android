...
public interface IFireflyCallbacks extends IInterface {
	...
	public static abstract class Stub_a extends Binder implements
		...
		public static IFireflyCallbacks asInterface_y(IBinder paramIBinder) {
			...
			if ((localIInterface != null)
					&& (localIInterface instanceof IFireflyCallbacks))
				return ((IFireflyCallbacks) localIInterface);
		...
		private static class Proxy_aimpl implements IFireflyCallbacks {
			private IBinder ky;
