...
import com.fireflycast.client.internal.FireflyClientEvents_ei;
 ...
 */
public final class FireflyApiClientImpl_b implements FireflyApiClient {
	private final FireflyClientEvents_ei mFireflyClientEvents_zx;
	...
	private final ReleaseCallback_a mReleaseCallback_zm = new ReleaseCallback_a() {
		public void onRelease_b(
				FireflyApiClientImpl_b.FireflyApiClientTask paramc) {
			mLock_zv.lock();
			try {
	 ...
	 * b$3.smali : OK
	 */
	private final FireflyClientEvents_ei.FmsClientEventCallback_b mFmsClientEventCallback_zM = new FireflyClientEvents_ei.FmsClientEventCallback_b() {
		public boolean canReceiveEvent_dC() {
			return mCanReceiveEvent_zJ;
		}

		public boolean isConnected() {
			return FireflyApiClientImpl_b.this.isConnected();
		}
	...
	public FireflyApiClientImpl_b(Context context, Looper looper,
			AccountInfo_ee account, Map<Api, ApiOptions> apiOptionsMap,
			Set<ConnectionCallbacks> connCallbacksSet,
			Set<OnConnectionFailedListener> connFailedListenerSet) {
		mFireflyClientEvents_zx = new FireflyClientEvents_ei(context, looper,
	...
	private <A extends Api.ConnectionApi_a> void execute_a(
		...
		mLock_zv.lock();
		try {
			ValueChecker_er.checkTrueWithErrorMsg(isConnected(),
	...
	public <C extends Api.ConnectionApi_a> C getConnectionApi_a(
		...
		ValueChecker_er.checkNullPointer_b(connection,
