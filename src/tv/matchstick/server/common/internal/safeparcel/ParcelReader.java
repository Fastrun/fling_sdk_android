...
public final class ParcelReader {
    public static int a(Parcel parcel)
    {
        ...
        if (end < start || end > parcel.dataSize())
            throw new FlingRuntimeException((new StringBuilder("Size read is invalid start="))
    ...
    public static void a(Parcel parcel, int i1, int expectedSize)
    {
        int k1 = a(parcel, i1);
        if (k1 != expectedSize)
            throw new FlingRuntimeException((new StringBuilder("Expected size "))
    ...
    public static Boolean d(Parcel parcel, int i1)
    {
        ...
        if (j1 == 0)
            return null;
        if (j1 != 4)
            throw new FlingRuntimeException((new StringBuilder("Expected size 4"))
