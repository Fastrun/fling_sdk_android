...
package tv.matchstick.server.fling.auth;
...
public final class FlingTrustManager implements X509TrustManager {
    public static FlingTrustManager a[];
    ...
    static {
        FlingTrustManager aatm[] = new FlingTrustManager[1];
        aatm[0] = new FlingTrustManager();
        a = aatm;
    }
